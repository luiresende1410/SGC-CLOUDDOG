  ...
  return (
    <ContentLayout
      header={
        <Header
          variant="h1"
          description={`Visao geral dos custos de colaboradores — ${periodoLabel}`}
        >
          Dashboard
        </Header>
      }
    >
      <SpaceBetween size="l">
        ...
        {!loading && totalColaboradores === 0 && !erro && (
          <Alert type="info">
            Nenhum registro de custo encontrado para {periodoLabel}. Importe dados ou ajuste o periodo.
          </Alert>
        )}
      </SpaceBetween>
    </ContentLayout>
